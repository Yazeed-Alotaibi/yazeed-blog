...
function cardFrom(html, id) {
  ...
  var hit = null;
  sandbox.PM_DATA.categories.forEach(function (cat) {
...
function build(spec, html, manifestPath) {
  ...
  return [
    ...
    '        <p class="byline">Yazeed Alotaibi · PMI-RMP · PRINCE2 · updated ' +
      esc(spec.updated) + '</p>',
    '      </div>',
    '',
    '      <section class="tool">',
    ...
    '    analytics watching. <a href="/">Back to all 34 calculators</a>.</p>',
    '  </footer>',
    '',
